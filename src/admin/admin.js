		...
		function () {
				...
				function ( tab ) {
					tab.addEventListener(
						...
						function ( e ) {
							...
							document.querySelectorAll( '.openqr-tab-panel' ).forEach(
								function ( panel ) {
			...
			if ( typeSelect ) {
				var syncType = function () {
					document.querySelectorAll( '.openqr-type-fields' ).forEach(
						function ( box ) {
				...
				document.querySelector( '#openqr-tab-static' ).addEventListener(
					'submit',
					function ( e ) {
						var form = e.target;
			...
			document.querySelectorAll( '.openqr-toggle-editor' ).forEach(
				function ( btn ) {
			...
			// ── Copy short links ────────────────────────────────────────────────────
			document.querySelectorAll( '.openqr-copy' ).forEach(
				function ( el ) {
			...
			document.querySelectorAll( '.openqr-pause' ).forEach(
				function ( btn ) {
					btn.addEventListener(
						'click',
						function () {
			...
			document.querySelectorAll( '.openqr-delete' ).forEach(
				function ( btn ) {
					btn.addEventListener(
						'click',
						function () {
